...
namespace AssemblerTwo.Lib
{
    public static class StaticAssembler
    {
        ...
        public static AssemblerBuildResult Build(string sourceText)
        {
        ...
        /*public ParseResult ParseWithErrorWrap(List<LexicalTokenInfo> lexicalTokens, StreamWriter log)
        {
            
        }*/

        public static AssemblerBuildResult UnprotectedBuild(string sourceText, string sourceName)
        {
            var result = new AssemblerBuildResult();
